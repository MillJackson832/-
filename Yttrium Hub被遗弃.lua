...
leftBox:AddLabel("  Yttrium-YTTRIUMv2脚本 ")
leftBox:AddLabel("----------------------------------")
leftBox:AddLabel("   状态:付费版用户  ")
leftBox:AddLabel("   更新:2026.2.21  ")
leftBox:AddLabel("     ")
leftBox:AddLabel("----------------------------------"))
...
bottomBorder:AddLabel("感谢使用Yttrium Hub脚本 - 祝您游戏愉快！")
bottomBorder:AddLabel("═════════════════════════════════")
...
local MenuGroup = Tabs["UI Settings"]:AddLeftGroupbox("Menu")
    ...
    ThemeManager:SetFolder("Yttrium Hub") 
SaveManager:SetFolder("Yttrium Hub/specific-game") 
